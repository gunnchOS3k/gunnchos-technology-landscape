...
**Chapter column** is derived from `figure_id` (`FIG-CHnn-…`). Some registry `chapter:` fields are truncated (for example `CH1-` instead of `CH11`); treat ID-derived chapters as the navigational truth until the registry is repaired.
