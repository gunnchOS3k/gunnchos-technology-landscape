...
**FIG-CH17-002** (illustrative timeline) later places cellular generations through 5G and marks **6G as roadmap**—research and standards direction, not a deployed consumer fact in this manuscript (CLM-CH17-003; `SOURCE_NEEDED` for a dated 3GPP study-item primary).

---

## 4. Follow the signal {#sec-signal}

**FIG-CH17-003** (conceptual sequence) shows a walk: indoor Wi-Fi association → approach exit → Wi-Fi weakens → cellular attachment or handover/offload → app traffic continues or stalls. Read it as a logical story, not as a measured drive test of your city.
