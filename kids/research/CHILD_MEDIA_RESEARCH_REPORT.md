...
| Metric | Count |
| --- | --- |
| Sources in source register | 24 |
| Evidence entries | 30 |
| Mandatory topics covered | 23 / 23 |
| Adopted production rules | 9 |
| Explicitly rejected unsupported claims | 6 |
...
**Characters.** A small, stable, emotionally legible original cast can support engagement and teach-back; do not copy third-party IP; avoid omniscient-AI tropes.

**Caregivers.** Serve-and-return and joint media engagement make caregiver co-use first-class for 0–5; print-first for infants/toddlers (AAP/WHO aligned).

**Pacing / ethics.** Fast fantastical pacing can briefly tax EF in preschool lab settings; design for comprehension, not watch-time. Autoplay off, no infinite engagement loops, privacy/agency by default (ICO AADC / COPPA / UNICEF principles).
...
See `adopted_production_rules` and `rejected_unsupported_claims` in the evidence register. Summary:
