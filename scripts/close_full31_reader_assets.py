...
FIGURE_SPECS: dict[str, tuple[str, str, str, list[str]]] = {
    ...
    "FIG-CH21-003": ("Model vs product vs claim families", "conceptual", "compare",
                     ["Model capability", "Product behavior", "Human claim", "Do not collapse"]),
    ...
    "FIG-CH26-003": ("Employment non-guarantee boundary", "conceptual", "boundary",
                     ["Portfolio evidence", "Skill signal", "Hiring decision", "No guarantee"]),
