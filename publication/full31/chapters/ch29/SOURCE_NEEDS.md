...
**Chapter:** CH29 — Designing a Complete Technology Product  
...
|---|---|---|---|
| `SRC-HARDWARE` | PHYSICAL_PENDING | repository | Device Quartet README / manufacturing readiness |
| `SRC-DEVICE-OS` | SOURCE_IDENTIFIED | repository | CLAIM_BOUNDARY / beta_gate docs |
| `product_design_refs` | SOURCE_NEEDED | textbook/official | Select non-marketing product engineering refs |
| `CE packages` | SOURCE_IDENTIFIED | publication-internal | CE-1…CE-6 synthesis inputs |

## Inheritance

Link deeper CE registers rather than copying:

- Whole-book ecosystem model
- CE-5/CE-6 responsibility + contract
