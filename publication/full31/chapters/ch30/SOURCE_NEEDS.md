...
**Chapter:** CH30 — Career Maps and Portfolio Proof  
...
|---|---|---|---|
| `careers/role_registry.yaml` | SOURCE_IDENTIFIED | publication-internal | Local role families |
| `CE CAREER_MAP.yaml` | SOURCE_IDENTIFIED | publication-internal | employment_guarantee false |
| `SRC-WAIKE` | SOURCE_IDENTIFIED | repository | portfolio_evidence / capstones @ e97e74fc9bfb44b1cdc26b272dc4848264f15fe0 |
| `bls_or_equivalent` | SOURCE_NEEDED | official statistics | Only if market claims are made |

## Inheritance

Link deeper CE registers rather than copying:

- CE CAREER_MAP.yaml patterns
- careers/ role_registry in publication repo
...
|---|---|
| `CLM-CH30-004` / `bls_or_equivalent` | Still `SOURCE_NEEDED` — human-verified BLS OOH (or equivalent); automated retrieval blocked; do not invent labor-market percentages |
