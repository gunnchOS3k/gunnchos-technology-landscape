# CH17 WAIKE Crosswalk (evidence-based)

**Publication chapter:** CH17 — Wi-Fi, Cellular, 5G, and the Road to 6G  
...
|---|---|---|---|---|
| CH17 wireless survey | `WIRELESS_6G` | digital_rc | **adjacent** | Use sparingly; avoid turning chapter into full 6G course |
| CH17 catalog | `wireless_dsp_6g` | catalog | **adjacent** | Name is 6G-oriented—do not overclaim |
| CH17 FSPL neighbor | `lab_fspl_budget` | digital_rc lab | **adjacent** | Forward CH18 |
| LAB-ACCESS-OBS-001 | `—` | — | **no-map** |  |
| Commercial 6G field lab | `—` | — | **no-map** | Non-claim |
