...
**Chapter:** CH25 — Digital Equity: Who Benefits, Who Is Excluded, and What We Can Measure  
...
|---|---|---|---|
| `SRC-WAIKE` | SOURCE_IDENTIFIED | repository | ACCESSIBILITY_AND_LOW_COST.md @ e97e74fc9bfb44b1cdc26b272dc4848264f15fe0 |
| `CE-6 package` | SOURCE_IDENTIFIED | publication-internal | publication/preproduction/ce-06/ |
| `ict_access_stats` | SOURCE_NEEDED | official statistics | Select ITU/NTIA/etc. with verified year/table |
| `wcag22-20241212` | SOURCE_IDENTIFIED | standards | Accessibility measurement context — dated key |

## Inheritance

Link deeper CE registers rather than copying:

- CE-6 equity/accessibility as contract conditions
- CE-5 responsible use
