...
**Chapter:** CH31 — Capstone: Explain, Measure, Improve, and Teach the Ecosystem  
...
|---|---|---|---|
| `publication/preproduction/ce-06/` | SOURCE_IDENTIFIED | publication-internal | Primary inherit |
| `LAB-CE06-001` | PROJECT_EVIDENCE_NEEDED | publication lab | FIXTURE_VALIDATED infra pending integrator merge |
| `SRC-WAIKE` | SOURCE_IDENTIFIED | repository | adjacent capstones/reproducible_research @ e97e74fc9bfb44b1cdc26b272dc4848264f15fe0 |
| `SRC-CE06-01` | SOURCE_IDENTIFIED | standards | ITU QoE vocabulary context via CE-6 register |

## Inheritance

Link deeper CE registers rather than copying:

- CE-6 full spine (primary inherit)
- CE-1…CE-5 synthesis
