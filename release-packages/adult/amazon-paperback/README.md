# Adult release package — `amazon-paperback`
...
- PRINT_INTERIOR_PDF from print-6x9 profile (628 pages, 6×9 in).
- Paperback eligibility: WITHIN_VERIFIED_KDP_BAND (band 24-828).
